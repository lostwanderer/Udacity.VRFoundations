...
- Scene : Only one Scene named "Main"
- Description : There are 6 coins(one is hidden), level of maze is pretty difficult. 
		Performed all optional challenges!(except adding lights)
